...
class Rossmann( object ):
    def __init__( self ):
        ...
        self.competition_time_week_scaler   = pickle.load( open(self.home_path + 'api/parameter/competition_time_week_scaler.pkl', 'rb'))
    ...
    def data_preparation(self, df5):
        ...
        # promo time week
        df5['promo_time_week'] = self.competition_time_week_scaler.transform(df5[['promo_time_week']].values)
